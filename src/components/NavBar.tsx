...
const links: NavLink[] = [
  { label: "Home", href: "/" },
  {
    ...
    href: "/programs",
    subItems: [
      { label: "STEM & Coding", href: "/programs" },
  ...
  { label: "Camp", href: "/camp" },
  {
    ...
    href: "/partnerships",
    subItems: [
      { label: "Existing Partnerships", href: "/partnerships" },
      { label: "Partnership Marketing", href: "/partnerships/marketing" },
    ],
  },
  ...
  return (
    <div className="sticky top-0 z-10 bg-blue-900">
      <header className="flex items-center justify-between px-5 md:px-10 py-4">
        <Link href="/" className="shrink-0 flex items-center bg-white rounded-md px-3 py-1.5">
          <Image
